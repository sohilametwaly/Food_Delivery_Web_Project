    ...
    <div className="rounded-[20px] shadow-xl flex flex-col gap-2 ">
      <div >
        <img src={url+"/images/"+img} alt="" className="rounded-tl-[20px] rounded-tr-[20px] w-full h-[200px]"/>
          ...
          {
                     !cartItems[id]?
                      <img src={assets.add_icon_white} onClick={() => {  addToCart(id) }} className="max-h-[40px] max-w-[40px] bottom-[108%] right-[1.5%] hover:cursor-pointer bottom-[140px] right-[5px] absolute"/>
              ...
              <div className="flex justify-between">
                  ...
                  <img src={assets.rating_starts} alt="" className="w-[75px] max-h-[25px] self-center" />
