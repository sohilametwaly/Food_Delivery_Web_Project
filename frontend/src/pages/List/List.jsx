  ...
  return (
    <>
      <div className="w-3/4 flex flex-col p-3 gap-2">
        <p className="text-[#ff6347] font-bold">All Foods List</p>
                ...
                <tr key={index} className="border-b-2">
                  <td className="flex items-center justify-center">
                    <img
                      ...
                      alt=""
                      className="max-w-30 max-h-20 p-2 "
                    />
                  </td>
                  ...
                  <td
                    className="text-center hover:cursor-pointer hover:bg-gray-100 font-bold"
